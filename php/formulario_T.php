...
<form action="todos.php" class="menu" method="post">
    ...
    <div class="form-row">
      <div class="form-group col-lg-5">
        <input type="date" class="form-control form-control-lg"  id="nascimento" name="data_nascimento" placeholder="DATA DE NASCIMENTO">
      </div>
      <div class="form-group col-lg-5 ">
        <input type="text" class="form-control form-control-lg" id="cpf" name="cpf" placeholder="CPF">
      </div>
    </div>
    <div class=form-group>
      <div class="form-group">
      ...
      <input type="password" class="form-control form-control-lg" id="password" name=senha placeholder="SENHA">
    </div>
      <input type="password" class="form-control form-control-lg" id="password1" placeholder="CONFIRMAR SENHA">
